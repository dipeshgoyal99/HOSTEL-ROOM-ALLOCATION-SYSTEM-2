...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="facility.php"
        aria-expanded="false"><i class="fas fa-book"></i><span
        class="hide-menu">Facilities</span></a></li>
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="about.php"
        aria-expanded="false"><i  data-feather="user"
                                        class="svg-icon mr-2 ml-1"></i><span
